...
import { HomeWrapper, HomeHeader, HomeAbout, HomeCommittees, HomeSecretaries, HomeGallery } from '../styles/pages/homeElements'
    ...
    <HomeWrapper>
      ...
      <Sidebar>
        <ul>
          ...
          <LinkSmooth smooth={true} to="secretaries">
            <li className="_3"> <GiPublicSpeaker /> <p className="text">Secretarías</p> </li>
          </LinkSmooth>
          <LinkSmooth smooth={true} to="gallery">
            <li className="_4"> <TiCameraOutline /> <p className="text">Galería</p> </li>
          </LinkSmooth>
          {user === USER_STATES.NOT_LOGGED && (
            <Link href="/signup">
              <li className="_5"> <TiKeyOutline /> <p className="text">Crear Cuenta</p> </li>
            </Link>
          )
          }
          {user && (
            <>
              <Link href="/profile">
                <li className="_5"> <HiUserCircle /> <p className="text">Perfil</p> </li>
              </Link>
              <li className="_6" onClick={signOut}> <FiLogOut /> <p className="text"> Cerrar Sesión </p> </li>
            </>
          )}
        </ul>
      </Sidebar>
      ...
      <HomeAbout>
        <div className="sec1" id="about">
          <h1> Quiénes Somos</h1>
          <p>
            AZTECMUN es un modelo de Naciones Unidas, proyecto educativo de Plantel Azteca que busca fomentar y desarrollar habilidades académicas para ayudar al fortalecimiento profesional y personal de los participantes, siendo así el comienzo para lograr el bien común en la sociedad a través de la concientización de los  problemas nacionales e internacionales.
            AZTECMUN parte de un proyecto con 17 años de trayectoria, logrando, reinventándose e implementando el debate en idioma inglés.
          </p>
          <Link href="signup">
      ...
      <HomeSecretaries id="secretaries">
        <div className="title"> <h1>Secretarías</h1> </div>
          ...
          <div className="secretarie">
            ...
            <div className="desc">
              <p>
                ...
                Es su deber prepararlos en el ámbito académico en aspectos como: los Modelos de Naciones Unidas y su papel para generar un cambio en la sociedad, plena comprensión de las funciones de la ONU y el desarrollo de sus habilidades de redacción de documentos, así como apoyarlos en la generación del material de apoyo que se utilizará durante el modelo.
              </p>
            </div>
          </div>
          ...
          <div className="secretarie">
            ...
            <div className="desc">
              <p>
                ...
                Como secretaria de Desarrollo Sostenible se promueve la iniciativa de los diecisiete ODS, impulsada por Naciones Unidas, y se busca adoptar medidas para generar la prosperidad económica compartida, el desarrollo social y la protección ambiental para todos los países.
          ...
          <div className="secretarie">
            ...
            <div className="desc">
              <p>
                ...
                We work together with the academic and protocol secretaries to translate different committees' documents to ensure the accurate use of English.
                It is our duty as English secretary to train the directive chairs in instances such as grammar, reading, writing, and pronunciation in English so that the chairs can help their delegates at the time of the debate and have good results during the United Nations Model.
